...
// Proxy Rules
// NOTE: In Docker Compose, hostnames are service names.
...
// PUBLIC CART (or optional auth?) - Let's keep cart public for now, but usually it's protected.
// User requirement: "Adding product to cart requires login". So Cart Service SHOULD be protected?
// User said: "Adding product to cart requires login". But maybe fetching cart?
// Let's protect WRITE operations or just trust the service to return 401?
// For now, let's protect /orders heavily.
